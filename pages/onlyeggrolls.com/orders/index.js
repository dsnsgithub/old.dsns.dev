...
async function grabOrders() {
	...
	if (response.length <= 0) {
		resultTable.innerHTML =
			"<h1 style='text-align:center;'>No Orders. If you have ordered but it hasn't shown up, please <a href='/login/'>login</a> to view account orders. <br> You must first link shopping sessions to an account to see them across devices.</h1>";
		return;
	}
