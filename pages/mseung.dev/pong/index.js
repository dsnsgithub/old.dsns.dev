...
function moveBall() {
    ...
    function checkCollision() {
        ...
        if(ball.offsetLeft < 10 && ball.offsetLeft >= 8) {
            if(ballPos.top <= (player1Pos.top + player1Pos.height) && ballPos.top >= player1Pos.top) { /*if ball's position collides with player 1's racket*/
            ...
            if(ballPos.top < (player2Pos.top + player2Pos.height) && ballPos.top > player2Pos.top) { /*if ball's position collides with player 2's racket*/
                angle = Math.random() * 2.5 - 1.5; /*change angle of ball*/
        ...
        if(ballPos.top <= 40 && ballPos.top >= 20) { /*system to check vertical collision*/
