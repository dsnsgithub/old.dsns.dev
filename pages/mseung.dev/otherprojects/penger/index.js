...
/*set up the stage-------------------------*/
const compdeck = [document.getElementById("compcard1"), document.getElementById("compcard2"), document.getElementById("compcard3"), document.getElementById("compcard4"), document.getElementById("compcard5")];
const playerdeck = [document.getElementById("playercard1"), document.getElementById("playercard2"), document.getElementById("playercard3"), document.getElementById("playercard4"), document.getElementById("playercard5")];
