...
function ConfettiGenerator() {var e = {target: "canvas",max:"300",size:"1",animate:!0,props:["circle", "square", "triangle", "line"],colors:[[165, 104, 246],[230, 61, 135],[0, 199, 228],[253, 214, 126]],clock:"25",rotate:!0,start_from_edge:!1,respawn:!0,interval:null,width:window.innerWidth,height:window.innerHeight},t ="object" == typeof e.target ? e.target : document.getElementById(e.target), r = t.getContext("2d"), a = []; function i(e, t) { e || (e = 1); var r = Math.random() * e; return t ? Math.floor(r) : r } var o = e.props.reduce(function (e, t) { return e + (t.weight || 1) }, 0); function n() { var t = e.props[function () { for (var t = Math.random() * o, r = 0; r < e.props.length; ++r){ var a = e.props[r].weight || 1; if (t < a) return r; t -= a } }()]; return { prop: t.type ? t.type : t, x: i(e.width), y: e.start_from_edge ? e.clock >= 0 ? -10 : parseFloat(e.height) + 10 : i(e.height), src: t.src, radius: i(4) + 1, size: t.size, rotate: e.rotate, line: Math.floor(i(65) - 30), angles: [i(10, !0) + 2, i(10, !0) + 2, i(10, !0) + 2, i(10, !0) + 2], color: e.colors[i(e.colors.length, !0)], rotation: i(360, !0) * Math.PI / 180, speed: i(e.clock / 7) + e.clock / 30 } } function s(t) { if (t) { var a = t.radius <= 3 ? .4 : .8; switch (r.fillStyle = r.strokeStyle = "rgba(" + t.color + ", " + a + ")", r.beginPath(), t.prop) { case "circle": r.moveTo(t.x, t.y), r.arc(t.x, t.y, t.radius * e.size, 0, 2 * Math.PI, !0), r.fill(); break; case "triangle": r.moveTo(t.x, t.y), r.lineTo(t.x + t.angles[0] * e.size, t.y + t.angles[1] * e.size), r.lineTo(t.x + t.angles[2] * e.size, t.y + t.angles[3] * e.size), r.closePath(), r.fill(); break; case "line": r.moveTo(t.x, t.y), r.lineTo(t.x + t.line * e.size, t.y + 5 * t.radius), r.lineWidth = 2 * e.size, r.stroke(); break; case "square": r.save(), r.translate(t.x + 15, t.y + 5), r.rotate(t.rotation), r.fillRect(-15 * e.size, -5 * e.size, 15 * e.size, 5 * e.size), r.restore(); break; case "svg": r.save(); var i = new window.Image; i.src = t.src; var o = t.size || 15; r.translate(t.x + o / 2, t.y + o / 2), t.rotate && r.rotate(t.rotation), r.drawImage(i, -o / 2 * e.size, -o / 2 * e.size, o * e.size, o * e.size), r.restore() } } } return { render: function () { t.width = e.width, t.height = e.height, a = []; for (var o = 0; o < e.max; o++)a.push(n()); return requestAnimationFrame(function t() { for (var o in r.clearRect(0, 0, e.width, e.height), a) s(a[o]); !function () { for (var t = 0; t < e.max; t++){ var r = a[t]; r && (e.animate && (r.y += r.speed), r.rotate && (r.rotation += r.speed / 35), (r.speed >= 0 && r.y > e.height || r.speed < 0 && r.y < 0) && (e.respawn ? (a[t] = r, a[t].x = i(e.width, !0), a[t].y = r.speed >= 0 ? -10 : parseFloat(e.height)) : a[t] = void 0)) } a.every(function (e) { return void 0 === e }) && _clear() }(), e.animate && requestAnimationFrame(t) }) } }}
